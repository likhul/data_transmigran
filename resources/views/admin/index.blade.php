...
<style>
    ...
    .soft-badge { padding: 6px 12px; border-radius: 8px; font-weight: 700; font-size: 0.75rem; }
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="bg-light rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 40px; height: 40px; color: var(--blue-primary);">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <form action="{{ route('admin.store') }}" method="POST" class="modal-content border-0 shadow-lg" style="border-radius: 24px;">
            ...
            <div class="modal-body p-4">
                ...
                <button type="submit" class="btn btn-blue w-100 py-3 fw-bold shadow-sm" style="border-radius: 15px;">SIMPAN AKUN</button>
            </div>
        </form>
    </div>
</div>
